 ...
 */
public class AvroWordOffsetInputFormat extends CombineFileInputFormat<AvroWordOffset, Text>
{
    @Override
    public RecordReader<AvroWordOffset, Text> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException
    {
     ...
     */
    private static class CombineFileLineRecordReader extends RecordReader<AvroWordOffset, Text>
    {
        ...
        @Override
        public AvroWordOffset getCurrentKey() throws IOException, InterruptedException
        {
            return key;
        }
